...
def test_sitemap_lists_exactly_32_urls(built_site):
    xml = (built_site / "sitemap.xml").read_text(encoding="utf-8")
...
def test_sitemap_urls_are_public_and_clean(built_site):
    xml = (built_site / "sitemap.xml").read_text(encoding="utf-8")
...
def test_sitemap_covers_hub_tonight_and_every_team(built_site):
